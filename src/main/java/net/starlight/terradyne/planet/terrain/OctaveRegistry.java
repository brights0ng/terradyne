...
public class OctaveRegistry {
    ...
    private static void logRegisteredOctaves() {
        ...
        Terradyne.LOGGER.info("  🏔️  GRANITE_MESAS: Broad rolling base + Dramatic mesas + Canyon systems");
        ...
        Terradyne.LOGGER.info("  🌾  RollingTerrainOctave: BROAD SWEEPING terrain visible EVERYWHERE under mesas");
    }
